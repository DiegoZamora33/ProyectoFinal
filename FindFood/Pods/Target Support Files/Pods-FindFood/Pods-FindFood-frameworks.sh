...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HideKeyboardTapGestureManager/HideKeyboardTapGestureManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LoadingAlert/LoadingAlert.framework"
